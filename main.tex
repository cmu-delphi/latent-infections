...
%- a_t\Delta C_t n_t  \right )^2 + \frac{\lambda}{2} \|D^{(3)}a\|_2^2 \label{eq:leakypr}
%\end{align}
%  $w_t$ be the inverse variance weights derived from those estimates,
\begin{align}
s_t = (1 -\gamma)s_{t-1} + a_t\Delta C_t n_t + \epsilon_t \label{eq:leakypr}
\end{align}
