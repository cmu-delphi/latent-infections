...
Table \@ref(tab:summary-table-data) presents a brief description of the key data sources, whether a relevant measure of uncertainty is included, and identifies major sources of delay that can present challenges for both retrospective and real-time infection estimation. More information on the restricted CDC line list, including details on how often it is updated, can be found at @cdc2020caserestr. The information stated about the GISAID data was retrieved from CoVariants.org [@hodcroft2021covariants]. The seroprevalence surveys are discussed in detail in Section \@ref(sec:serop). Finally, the 2022 publication on reinfection data is referenced as @ruff2022rapid.
...
\hline
\textbf{Data Source}                                                                     & \textbf{Brief description}                                                                                                   & \textbf{\begin{tabular}[c]{@{}l@{}}Uncertainty \\ measure \\ provided\end{tabular}} & \textbf{Major sources of delay}                                                                                                                                                                                                                                                                                                                                                                                                                                                                \\ \hline
\begin{tabular}[c]{@{}l@{}}JHU CSSE \\ Reported Cases\end{tabular}                       & \begin{tabular}[c]{@{}l@{}}Daily new confirmed \\ COVID-19 cases \\ by date of report\end{tabular}                           & No                                                                                  & \begin{tabular}[c]{@{}l@{}}Includes delays caused by time- and location-varying \\ reporting to public health, as well as additional delays\\  throughout the pipeline, such as those due to testing, \\ data processing, and reporting backlogs.\end{tabular}                                                                                                                                                                                                                                 \\ \hline
CDC Linelist                                                                             & \begin{tabular}[c]{@{}l@{}}Individual-level data\\ on symptom onset, \\ specimen collection \\ and report dates\end{tabular} & No                                                                                  & \begin{tabular}[c]{@{}l@{}}Similar to JHU CSSE, the time required for the \\ pipeline to process data may vary as jurisdictions \\ collect, process, and report information to the CDC. \\ Additionally, the restricted CDC line list is \\ updated monthly, creating a gap between data \\ collection and update. At the individual \\ case level, data is often initially reported based \\ on lab results, with additional information \\ from patient interviews added later.\end{tabular} \\ \hline
\begin{tabular}[c]{@{}l@{}}GISAID variant \\ proportions \\ from CoVariants\end{tabular} & \begin{tabular}[c]{@{}l@{}}Total number of \\ biweekly sequences \\ categorized by variant \\ group\end{tabular}             & No                                                                                  & \begin{tabular}[c]{@{}l@{}}Location- and time-specific delays in \\ sequencing, processing, and public availability, \\ with updates typically taking at least two \\ weeks from sample collection to data publication.\end{tabular}                                                                                                                                                                                                                                                           \\ \hline
\begin{tabular}[c]{@{}l@{}}Seroprevalence \\ surveys\end{tabular}                        & \begin{tabular}[c]{@{}l@{}}\% of individuals with\\ at least one past or \\ resolving COVID-19\\ infection\end{tabular}      & \begin{tabular}[c]{@{}l@{}}Yes \\ (95\% CIs)\end{tabular}                           & \begin{tabular}[c]{@{}l@{}}Delays due to the cross-sectional study designs, \\ infrequent and potentially lengthy data collection \\ (e.g., multi-week or monthly), inconsistent\\ data collection. Additional delays due \\ to data collection, processing, and reporting.\end{tabular}                                                                                                                                                                                                       \\ \hline
Reinfection data                                                                         & \begin{tabular}[c]{@{}l@{}}The fraction of \\ infections that \\ are reinfections\end{tabular}                               & No                                                                                  & \begin{tabular}[c]{@{}l@{}}Delays in public accessibility of reinfection data, \\ as 2020-2021 data was reported in a 2022\\ publication, and due to the 90-day interval\\  criteria for suspected reinfections. Additional \\ delays would occur if the reinfections were \\ confirmed by genomic sequencing.\end{tabular}                                                                                                                                                                    \\ \hline
\end{tabular}
}
