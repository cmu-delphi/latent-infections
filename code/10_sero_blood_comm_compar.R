...
# Try A. approach to aggregate these into a single date per month - median of the median dates
...
ggplot(sero_blood_df, aes(Date, y = Rate)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 7),
        ...
        strip.text = element_text(size = 9, face = "bold", margin = margin(1, 0, 1, 0, "mm")),
