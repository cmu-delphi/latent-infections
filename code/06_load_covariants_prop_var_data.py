...
# Add missing values with NAN
seq_df_filled = seq_df.set_index('Date').groupby('State').resample('1D').mean().reset_index()

# Save CSV of filled data
seq_df_filled.to_csv("seq_df_filled_Nov5.csv", index=False)