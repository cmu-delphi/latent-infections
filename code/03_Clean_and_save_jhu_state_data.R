...
# Line plot of CHU confirmed incidence count
...
# Want to know if all 1143 days between the min and max dates have been observed for all states
View(jhu %>% group_by(geo_value) %>% count())
