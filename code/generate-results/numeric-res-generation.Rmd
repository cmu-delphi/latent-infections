...
corrs_hosp <- read_rds("data/inf_case_corrs_hosp.rds") 
corrs_deaths <- read_rds("data/inf_case_corrs_deaths.rds") 
```
...
adj_df %>%
  ...
  select(geo_value, date, adj_inf_rate, ninetyfive_lowb_rate, ninetyfive_upb_rate)
...
## The relationship between infections and hospitalizations/deaths is complicated.
