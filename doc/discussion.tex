...
Case reporting varied widely over time and across locations globally, not just in 
the 
...
driven 
by differing testing capacities and reporting standards, makes it difficult to establish 
 accurate infection trends and investigate appropriate responses. Misleading spatial 
patterns of reported cases, such as overrepresentation in some areas and 
underreporting in 
others
 (a glimpse of which was shown in \Cref{fig:choro_inf_case_rates}), further 
exacerbate the difficulty in 
...
decisions.
 ...
 through large-scale infection-prevalence surveys (e.g.\ the REACT-1 study, 
\citealp{react12022}),
...
would likely impact right censoring and increase volatility in real-time estimation, 
see Appendix~A. 
...
However, future work could further refine this analysis. Because the waning of immunity
...
decline, the opposite occurs. This dynamic relationship between infection 
...
especially during rapid changes in the epidemic trajectory. 
...
availability, and policy decisions, among other reasons. Additionally, this
fixed lag
