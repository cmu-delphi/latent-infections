...
\subsection{Estimated delays}

\attn{we should actually show some of the delay distribution estimates.}
...
\centering
    ...
    for which the highest average correlation is attained. \attn{This figure is
    out of date.}}
