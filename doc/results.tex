...
and Montana (\Crefrange{fig:state_infect_est}{fig:six-states}). During this
...
for any state. \attn{Can you put one sentence that compares these to the case
...
cases by about 41 and 6 days at the peaks (\Cref{fig:state_infect_est}). Such
...
at a lag of 13 days (\Cref{fig:correlations}). In contrast, we find that the
