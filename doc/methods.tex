...
\Cref{fig:cases_to_infect_flowchart} provides a visual summary of the major
...
%, as estimated from de-identified patient-level
...
(\Cref{sec:linelist-details}). Define $z_{\ell,t}$ to be a case report occurring
...
variant-specific.
We use our estimates from \Cref{sec:step1},
...
also \Cref{sec:variant-proportions}). The resulting
...
\Cref{sec:delay-sops,sec:incubation,sec:details-conv}. 
...
\citep{cdc2021blood, cdc2021comm} (\Cref{sec:sero-details}). 
...
in Supplementary Methods \Cref{sec:ablation}.
