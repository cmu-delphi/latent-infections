...
\centering
    ...
    \caption{Flowchart of the data and major analysis steps required to
    get from reported cases to incident infection estimates.}
...
\attn{Daniel, This section could also be moved to the supp mat
if we're looking for stuff to cut from the main body before introducing the models.}
