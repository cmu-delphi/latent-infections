...
\Cref{sec:step1}, with variant-specific incubation periods (details for these
are given in the Supplement, \Cref{sec:incubation}). \attn{Rachel: please ensure
that the details of the supports and the expression for this convolution are in
the supplement (both this section and the previous).} The convolution of these
...
\Cref{sec:step2-and-3}), $z_{\ell,m}$ is the fraction of reinfections, and
