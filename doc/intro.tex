...
to their infection onset. Finally, we adjust the resulting deconvolved cases to account 
for unreported infections using seroprevalence and reinfection data to adjust for the 
